...
impl<'a, K: Ord, V> Iterator for IndexTreeIterator<'a, K, V> {
    type Item = (&'a K, &'a V);
...
impl<'a, K: Ord> Iterator for IndexTreeSetIterator<'a, K> {
    type Item = &'a K;
...
impl<'a, K: Ord, V> Iterator for IndexTreeKeys<'a, K, V> {
    type Item = &'a K;
...
impl<'a, K: Ord, V> Iterator for IndexTreeValues<'a, K, V> {
    type Item = &'a V;
